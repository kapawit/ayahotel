...
public class Login extends javax.swing.JFrame {
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        try {
            con = Koneksi.Koneksi();
            sql = "SELECT * FROM user WHERE username='"+unameTF.getText()+"' AND password='"+passTF.getText()+"'";
            stat = con.createStatement();
            rs = stat.executeQuery(sql);
            if(rs.next()){
                if(unameTF.getText().equals(rs.getString("username")) && passTF.getText().equals(rs.getString("password"))){
                    Id = rs.getInt("id");
